...
int main() {
    ...
    for (int i=0; i<100; i++) {
        new node; //creates 100 new unusable nodes in memory
    }
...
// p current is at the end of the list after the while loop
        //pCurrent = pHead;

    // TODO: Use a for loop to output the list
     for (pCurrent = pHead; pCurrent != nullptr; pCurrent = pCurrent->next ) {
        cout << pCurrent->data;
     }
